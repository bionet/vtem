# -*- coding: utf-8 -*-
#
# Video Time Encoding and Decoding Machines documentation build configuration file, created by
# sphinx-quickstart on Wed Dec 24 17:10:30 2014.
#
...
MOCK_MODULES = ['scikits', 'scikits.cuda', 'scikits.cuda.cublas',
                'scikits.cuda.cula',
...
texinfo_documents = [
  ('index', 'vtem', u'Video Time Encoding and Decoding Machines Documentation',
   u'Nikul H. Ukani, Yiyin Zhou', 'VideoTimeEncodingandDecodingMachines', 'One line description of project.',
   'Miscellaneous'),
]
